...
function MessageScrollerButton({
  ...
  return (
    <MessageScrollerPrimitive.Button
      ...
      direction={direction}
      className={cn(
        // `left-1/2` + `-translate-x-1/2` memusatkan tombol secara horizontal.
        // Sebelumnya `inset-s-1/2` dipakai, tapi itu bukan utility Tailwind
        // yang valid — tidak ada CSS yang di-emit, sehingga tombol kehilangan
        // posisi horizontalnya dan tergeser ke kiri oleh translate.
